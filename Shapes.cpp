...
point4 cubePoints2 [numCubeVertices];
point3 cubeNormals2[numCubeVertices];
point2 cubeUV2     [numCubeVertices];
...
void quad2( int a, int b, int c, int d, const point3& normal )
{
	if(Index == numCubeVertices)
		Index = 0;
    cubePoints2[Index] = vertices[a]; cubeNormals2[Index] = normal; 
    cubeUV2[Index] = point2(-0.3776595f, 1.5f); Index++; //topleft
    cubePoints2[Index] = vertices[b]; cubeNormals2[Index] = normal;
    cubeUV2[Index] = point2(-0.3776595f, -0.5f); Index++; //bottomleft
    cubePoints2[Index] = vertices[c]; cubeNormals2[Index] = normal;
    cubeUV2[Index] = point2(1.3776595f, -0.5f); Index++; //bottomright
    cubePoints2[Index] = vertices[a]; cubeNormals2[Index] = normal;
    cubeUV2[Index] = point2(-0.3776595f, 1.5f); Index++; //topleft
    cubePoints2[Index] = vertices[c]; cubeNormals2[Index] = normal;
    cubeUV2[Index] = point2(1.3776595f, -0.5f); Index++; //bottomright
    cubePoints2[Index] = vertices[d]; cubeNormals2[Index] = normal;
    cubeUV2[Index] = point2(1.3776595f, 1.5f); Index++; //topright
}
...
void colorcube2()
{
    quad2( 1, 0, 3, 2, point3( 0.0f,  0.0f,  1.0f) );
    quad2( 2, 3, 7, 6, point3( 1.0f,  0.0f,  0.0f) );
    quad2( 3, 0, 4, 7, point3( 0.0f, -1.0f,  0.0f) );
    quad2( 6, 5, 1, 2, point3( 0.0f,  1.0f,  0.0f) );
    quad2( 4, 5, 6, 7, point3( 0.0f,  0.0f, -1.0f) );
    quad2( 5, 4, 0, 1, point3(-1.0f,  0.0f,  0.0f) );
}
...
void generateCube2(GLuint program, ShapeData* cubeData)
{
    colorcube2();
    cubeData->numVertices = numCubeVertices;
